...
\r
        <div style="color: rgb(244, 244, 244)">\r
            ...
            <ul>\r
                <li><strong>changeValue(value: number): void</strong> - происходит когда изменяется значение. В него\r
                    передаётся\r
                    новое количество выбранных делений\r
                </li>\r
            </ul>\r
\r
            <br>\r
            ...
            <ul>\r
                ...
                <li>\r
                    ...
                    необхадимые теги.\r
                    <i>Теги Button используются с целью повышения доступности, т.к. они нативно фокусируются при нажатии\r
                        на\r
