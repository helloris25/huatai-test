...
<Hst.Story title="ScaleBar" responsiveDisabled>
    <div style="background: #333; padding: 25px">
        ...
        <div style="color: rgb(244, 244, 244)">
            ...
            <ul>
                <li><strong>changeValue(value: number): void</strong> - происходит когда изменяется значение. В него
                    передаётся
            ...
            <ul>
                ...
                <li>
                    ...
                    необхадимые теги.
                    <i>Теги Button используются с целью повышения доступности, т.к. они нативно фокусируются при нажатии
                        на
